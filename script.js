...
const getResult = async (e) => {
    const url = `http://www.omdbapi.com/?apikey=e2dc9c94&s=${input.value}&page=1`;
...
const getDetail = async (name, year) => {
    const url1 = `http://www.omdbapi.com/?apikey=e2dc9c94&t=${name}&y=${year}&plot=full`;
    ...
    if (clickedElement.classList.contains('movie-btn') || clickedElement.tagName === "IMG" || clickedElement.tagName === "SPAN") {
        ...
        <div class="img-container">
                    ...
                    <div class="title-container">
                        ...
                        <p><b style="color:#ff7373">WRITER</b> : ${movieData.Writer}, <spanp><b style="color:#ff7373">DIRECTOR</b>  : ${movieData.Director}</span></p> 
